...
const FeatureCard: React.FC<{
  ...
  <div className="w-[395px] shadow-[0_4px_6px_rgba(0,0,0,0.1),0_10px_15px_rgba(0,0,0,0.1)] bg-white p-6 rounded-lg max-md:w-[300px] max-sm:w-full max-sm:max-w-[400px]">
...
export const Features: React.FC = () => {
  return (
    <section className="bg-gray-50 px-20 py-16 max-sm:p-4">
