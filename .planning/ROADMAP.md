...
Plans:
- [x] 02-01-PLAN.md -- Azure Face API integration in verify-face edge function
- [x] 02-02-PLAN.md -- Fire-and-forget frontend wiring in Timeclock.tsx
...
Plans:
- [x] 03-01-PLAN.md -- Flag indicators on timeline cards + flagged count in summary
- [x] 03-02-PLAN.md -- Side-by-side photo review dialog with approve/reject actions
...
| 3 - Admin Review | ✓ Complete | ADMIN-01, ADMIN-02, ADMIN-03, ADMIN-04 |
